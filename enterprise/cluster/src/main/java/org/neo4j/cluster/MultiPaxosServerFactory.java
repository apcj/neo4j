        ...
        implements ProtocolServerFactory
{
    ...
    @Override
    public ProtocolServer newProtocolServer( InstanceId me, int maxSurvivableFailedMembers,
                                             ...
                                             ObjectOutputStreamFactory objectOutputStreamFactory )
    {
        ...
        final MultiPaxosContext context = new MultiPaxosContext( me, maxSurvivableFailedMembers,
