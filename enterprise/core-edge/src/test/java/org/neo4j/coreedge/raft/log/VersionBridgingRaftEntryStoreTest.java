...
public class VersionBridgingRaftEntryStoreTest
{
    ...
    public void shouldReadAcrossVersionBoundary() throws Exception
    {
        ...
        when( versionReader.readEntriesInVersion( 2 ) ).thenReturn(
                cursor( entry4, entry5 ) );
        when( versionReader.readEntriesInVersion( 3 ) ).thenReturn(
    ...
    public void shouldCloseUnderlyingCursors() throws Exception
    {
        ...
        for ( int i = 0; i < 10; i++ )
        {
            ...
            when( versionReader.readEntriesInVersion( i ) ).thenReturn( versionCursor );
        }
