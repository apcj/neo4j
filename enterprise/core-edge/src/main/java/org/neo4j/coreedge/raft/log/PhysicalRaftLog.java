...
// TODO: Handle recovery with regards to continuation records, appendIndex, etc.
public class PhysicalRaftLog implements RaftLog, Lifecycle
{
    ...
    @Override
    public IOCursor<RaftLogEntry> getEntryCursor( long fromIndex ) throws IOException, RaftLogCompactedException
    {
    ...
    {
        final Reference<LogPosition> firstFile = new Reference<>();
